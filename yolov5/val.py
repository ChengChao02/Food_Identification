...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/orange.yaml', help='dataset.yaml path')#修改数据
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / r'runs/train/exp4/weights/best.pt', help='model.pt path(s)')
